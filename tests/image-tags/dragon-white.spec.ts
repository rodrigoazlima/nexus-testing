...
test.describe.serial('Image tags: dragon-white.jpg -> vision draft', () => {
  ...
  test('dragon-white.jpg gets expected tags, name, and draft state, and lands in the bestiary', async ({
    page,
  }) => {
    ...
    await test.step('validate tags', () => {
      assertTagsInclude(data.tags, EXPECTED_TAGS, 'dragon-white.jpg');
    });
