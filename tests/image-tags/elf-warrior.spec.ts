...
test.describe.serial('Image tags: elf-warrior.jpg -> vision draft', () => {
  ...
  test.afterEach(async ({}, testInfo) => {
    if (testInfo.status !== testInfo.expectedStatus) {
      ...
      console.log(`[image-tags/elf-warrior] FAILED — files copied for inspection to ${dir}`);
    }
  });
  ...
  test('elf-warrior.jpg gets expected tags, name, and draft state', async () => {
