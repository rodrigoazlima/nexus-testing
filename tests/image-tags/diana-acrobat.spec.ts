...
test.describe.serial('Image tags: diana-acrobat.jpg -> vision draft', () => {
  ...
  test.afterEach(async ({}, testInfo) => {
    if (testInfo.status !== testInfo.expectedStatus) {
      ...
      console.log(`[image-tags/diana-acrobat] FAILED — files copied for inspection to ${dir}`);
    }
  });
  ...
  test('diana-acrobat.jpg gets expected tags, name, and draft state', async () => {
