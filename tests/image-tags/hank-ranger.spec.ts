...
const EXPECTED_TAGS = ['portrait', 'ranger'];
...
test.describe.serial('Image tags: hank-ranger.jpg -> vision draft', () => {
  ...
  test('hank-ranger.jpg gets expected tags, name, and draft state', async () => {
    ...
    await test.step('validate tags', () => {
      assertTagsInclude(data.tags, EXPECTED_TAGS, 'hank-ranger.jpg');
    });
  });
});
