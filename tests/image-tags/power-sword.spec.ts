...
test.describe.serial('Image tags: Power_Sword.webp -> vision draft', () => {
  ...
  test.afterEach(async ({}, testInfo) => {
    if (testInfo.status !== testInfo.expectedStatus) {
      ...
      console.log(`[image-tags/power-sword] FAILED — files copied for inspection to ${dir}`);
    }
  });
  ...
  test('Power_Sword.webp gets expected tags, name, and draft state', async () => {
