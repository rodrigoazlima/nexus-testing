...
test.describe.serial('Image tags: half-orc.jpg -> vision draft', () => {
  ...
  test.afterEach(async ({}, testInfo) => {
    if (testInfo.status !== testInfo.expectedStatus) {
      ...
      console.log(`[image-tags/half-orc] FAILED — files copied for inspection to ${dir}`);
    }
  });
  ...
  test('half-orc.jpg gets expected tags, name, and draft state', async () => {
